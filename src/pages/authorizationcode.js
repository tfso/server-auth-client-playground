        ...
        output.push(html`
            <div class="step">
                ...
                <div class="step-content">
                    <${RequestTemplate} title="Authorization Code" onEdit=${this.handleEdit.bind(this)} onResponse=${this.handleRedirectResponse.bind(this)} url=${this.authorizationUrl} type="authorizationUrl" params=${{ response_type: 'code', client_id: this.clientId, redirect_uri: window.location.href, scope: this.scope, state: this.state, tenant: this.tenant, audience: this.audience }}><//>
                </div>
            </div>
        `)
            ...
            output.push(html`
                <div class="step">
                    ...
                    <div class="step-content">
                        ...
                        <${RequestTemplate} onEdit=${this.handleEdit.bind(this)} onResponse=${this.handleTokenResponse.bind(this)} contentType="application/x-www-form-urlencoded" url=${this.tokenUrl} type="tokenUrl" params=${{ grant_type: 'authorization_code', code: this.code, client_id: this.clientId, client_secret: this.clientSecret, redirect_uri: window.location.href }}><//>
                    </div>
                </div>
            `)
        }
            ...
            output.push(html`
                <div class="step">
                    ...
                    <div class="step-content">
                        ...
                        <${RequestTemplate} onEdit=${this.handleEdit.bind(this)} onResponse=${this.handleRefreshTokenResponse.bind(this)} contentType="application/x-www-form-urlencoded" url=${this.tokenUrl} type="tokenUrl" params=${{ grant_type: 'refresh_token', refresh_token: this.refreshToken, client_id: this.clientId, client_secret: this.clientSecret, scope: this.scope, tenant: this.tenant, redirect_uri: window.location.href }}><//>
                    </div>
                </div>
            `)
        }
